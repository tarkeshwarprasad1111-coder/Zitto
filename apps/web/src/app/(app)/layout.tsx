...
// MOCK: wallet and notification counts come from `GET /wallet` and
// `GET /notifications` once the API is wired.
import { mockUnreadNotificationCount, mockWallet } from '@/lib/mock-data';
  ...
  return (
    <div className="flex min-h-dvh flex-col">
      <TopBar
        ...
        unreadNotifications={mockUnreadNotificationCount}
      />
